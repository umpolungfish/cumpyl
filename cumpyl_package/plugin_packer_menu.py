...
def list_available_plugins() -> Dict[str, List[str]]:
    ...
    # Look for plugin files in the root 'plugins' directory
    plugins_dir = os.path.join(os.path.dirname(os.path.abspath(__file__)), '..', 'plugins')
    if not os.path.exists(plugins_dir):
        # Fallback to package resources if the directory structure is different
        try:
            ...
            print("Warning: Could not list plugins from package resources.")
            return {'analysis': [], 'transformation': []}
