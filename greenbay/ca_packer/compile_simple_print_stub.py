#!/usr/bin/env python3
"""
Compilation script for the simple print stub
"""
...
def compile_simple_print_stub():
    """Compile the simple print stub"""
    logging.basicConfig(level=logging.DEBUG)
    
    current_dir = os.path.dirname(os.path.abspath(__file__))
    stub_source = os.path.join(current_dir, "simple_print_stub.c")
    stub_obj = os.path.join(current_dir, "simple_print_stub.o")
    stub_elf = os.path.join(current_dir, "simple_print_stub.elf")
    stub_blob = os.path.join(current_dir, "simple_print_stub_compiled.bin")
    ...
    try:
        ...
        logging.info(f"Simple print stub compiled successfully to blob: {stub_blob}")
        print(f"Simple print stub blob created at: {stub_blob}")
