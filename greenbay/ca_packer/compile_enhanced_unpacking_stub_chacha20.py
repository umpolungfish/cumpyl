#!/usr/bin/env python3
"""
Compilation script for the ChaCha20-enhanced unpacking stub
"""
...
def compile_enhanced_unpacking_stub_chacha20():
    """Compile the ChaCha20-enhanced unpacking stub"""
    logging.basicConfig(level=logging.DEBUG)
    
    current_dir = os.path.dirname(os.path.abspath(__file__))
    stub_source = os.path.join(current_dir, "enhanced_unpacking_stub_chacha20.s")
    stub_obj = os.path.join(current_dir, "enhanced_unpacking_stub_chacha20.o")
    stub_elf = os.path.join(current_dir, "enhanced_unpacking_stub_chacha20.elf")
    stub_blob = os.path.join(current_dir, "enhanced_unpacking_stub_chacha20_compiled.bin")
    ...
    try:
        ...
        logging.info(f"ChaCha20-enhanced unpacking stub compiled successfully to blob: {stub_blob}")
        print(f"ChaCha20-enhanced unpacking stub blob created at: {stub_blob}")
...
if __name__ == "__main__":
    compile_enhanced_unpacking_stub_chacha20()