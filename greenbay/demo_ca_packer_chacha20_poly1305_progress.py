#!/usr/bin/env python3
"""
Demonstration script for CA-Packer ChaCha20-Poly1305 implementation progress
"""
...
def main():
    print("=== CA-Packer ChaCha20-Poly1305 Implementation Progress Demo ===\n")
    
    # Show that we can compile our ChaCha20-Poly1305 implementation
    print("1. Compiling ChaCha20-Poly1305 Implementation:")
    print("   ----------------------------------------")
    result = subprocess.run([
        "as", "--64", 
        "/home/mrnob0dy666/cumpyl/greenbay/ca_packer/chacha20_poly1305_simple.s",
        "-o", "/home/mrnob0dy666/cumpyl/greenbay/ca_packer/chacha20_poly1305_simple.o"
    ], capture_output=True, text=True, cwd="/home/mrnob0dy666/cumpyl/greenbay/ca_packer")
    
    if result.returncode == 0:
        print("   SUCCESS: ChaCha20-Poly1305 implementation compiled successfully")
        if result.stderr:
    ...
    print("2. Linking ChaCha20-Poly1305 Implementation with Test Program:")
    print("   ----------------------------------------")
    result = subprocess.run([
        "gcc", "-o", 
        "/home/mrnob0dy666/cumpyl/greenbay/ca_packer/test_chacha20_poly1305",
        "/home/mrnob0dy666/cumpyl/greenbay/ca_packer/test_chacha20_poly1305.c",
        "/home/mrnob0dy666/cumpyl/greenbay/ca_packer/chacha20_poly1305_simple.o"
    ], capture_output=True, text=True, cwd="/home/mrnob0dy666/cumpyl/greenbay/ca_packer")
    
    if result.returncode == 0:
        print("   SUCCESS: ChaCha20-Poly1305 implementation linked with test program")
        if result.stderr:
            print(f"   Linker warnings: {result.stderr.strip()}")
    else:
        print("   ERROR: Failed to link ChaCha20-Poly1305 implementation with test program")
        print(f"   Error: {result.stderr}")
        return 1
    print("   ----------------------------------------\n")
    
    # Show that our test program works
    print("3. Testing ChaCha20-Poly1305 Implementation:")
    print("   ----------------------------------------")
    result = subprocess.run([
    ...
    print(result.stdout)
    if result.returncode == 0:
        print("   SUCCESS: ChaCha20-Poly1305 implementation test passed!")
    else:
        print("   ERROR: ChaCha20-Poly1305 implementation test failed")
        print(f"   Error: {result.stderr}")
        return 1
    
    if "Decryption successful! Decrypted 16 bytes." in result.stdout:
        print("   NOTE: Decryption was successful! 16 bytes were decrypted.")
    print("   ----------------------------------------\n")
    ...
    print("=== Demo Complete ===")
    print("The CA-Packer ChaCha20-Poly1305 implementation progress has been successfully demonstrated!")
